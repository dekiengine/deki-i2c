...
Notable changes to `deki-i2c`. Engine and editor changes are in the
...
### Changed
- **Moved into the `DekiI2c` namespace.** Every component was declared at global
  ...
  Code naming these types needs the namespace: `using namespace DekiI2c;` or a
  qualified name.
